...
def setup_wa():
    ...
    pyautogui.click(487, 193, duration=1)
    time.sleep(0.1)

    pyautogui.write("ESEA Outdoors welcome group", interval=0.01)

    pyautogui.click(436, 293, duration=1)
    time.sleep(0.1)

    pyautogui.click(1284, 90, duration=1)
    time.sleep(0.1)

    pyautogui.click(763, 163, duration=1)
    time.sleep(0.1)


def search_numbers(numbers):
    pyautogui.click(978, 198, duration=1)
    time.sleep(0.1)
    in_group = []
